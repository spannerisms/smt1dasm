...
#_0080E5: LDX.b #$00 ; This is just zeroing everything
...
#_00847B: INY
#_00847C: DEX
#_00847D: BNE .branch008474

#_00847F: DEC.w $0100
#_008482: BNE .branch008467
...
#_0084AF: INY
#_0084B0: DEX
#_0084B1: BNE .branch0084A8

#_0084B3: CPY.w $0100
#_0084B6: BCS .branch0084BD

#_0084B8: INC.w $0102
#_0084BB: BRA .branch00849F
...
#_0084FB: DEX
#_0084FC: BNE .branch0084EF

#_0084FE: DEC.w $7E22FD
#_008501: BNE .branch0084E1
...
#_00866E: REP #$20
#_008670: LDA.l IRQ_subs,X

#_008674: STA.w $1926

#_008677: LDA.w #EXIT_IRQ-1
#_00867A: PHA
...
#_008787: PHP ; First part seems to zero OAM
...
#_008944: JMP routine008838_preset
...
;===================================================================================================
; After using Divide_32bit_by_16bit
...
#_008E74: ASL A
#_008E75: CMP.w $0E84
#_008E78: BCC .rounddown

#_008E7A: INC.w $0E80
#_008E7D: BNE .norollover
...
.branch008E94
#_008E94: PHK ; just long there ok
#_008E95: JSR Divide_32bit_by_16bit_preset ; dividing by 10 for hex to dec
#_008E98: LDA.w $0E86
#_008E9B: CLC
#_008E9C: ADC.w #$0001
#_008E9F: BIT.w $0E88
...
.branch008EDC
#_008EDC: PHK
#_008EDD: JSR Divide_32bit_by_16bit_preset
#_008EE0: LDA.w $0E86
...
#_00908E: ORA.w #$8000
#_009091: STA.w $0E9A
#_009094: LDA.w #!SFX_03
#_009097: JSL Write_to_APU_transferrable
#_00909B: BRA .exit

.pressed_A
#_00909D: LDA.w #!SFX_02
...
.branch00975E
#_00975E: LDA.b ($90),Y ; copies number of dmas; vram location; size of dma
#_009760: STA.w $0100,Y

#_009763: INY
#_009764: INY
#_009765: CPY.w #$0006
#_009768: BCC .branch00975E

#_00976A: LDX.w #$0000

.branch00976D
#_00976D: LDA.b ($90),Y
#_00976F: CMP.w #$FFFF ; if not FF, just write
...
#_0097B0: LDA.w $0100
#_0097B3: ORA.w #$8000 ; Flag the DMA i guess
#_0097B6: STA.w $0100
#_0097B9: PLB
#_0097BA: RTL
...
#_009E1E: PHP
#_009E1F: REP #$30
#_009E21: JSR Blank0106TextBuffer
#_009E24: LDA.w #VRAMaddr($7870) ; VRAM $7870 where the menu is
#_009E27: STA.w $0102
#_009E2A: LDA.w #$000B
#_009E2D: STA.w $0104
#_009E30: LDA.w #$8042
...
#_009E3B: PHP
#_009E3C: REP #$30
#_009E3E: JSR Blank0106TextBuffer
#_009E41: LDA.w #VRAMaddr($79C4) ; money tile map address
#_009E44: STA.w $0102
#_009E47: LDA.w #$0002
#_009E4A: STA.w $0104
#_009E4D: LDA.w #$800E
...
#_009E59: PHP
#_009E5A: REP #$30
#_009E5C: JSR Blank0106TextBuffer
#_009E5F: LDA.w #VRAMaddr($7906)
#_009E62: STA.w $0102
#_009E65: LDA.w #$0002
#_009E68: STA.w $0104
#_009E6B: LDA.w #$800C
...
#_009E7A: JSR Blank0106TextBuffer
#_009E7D: LDA.w #VRAMaddr($7846)
#_009E80: STA.w $0102
...
#_009EB3: PHP
#_009EB4: REP #$30
#_009EB6: JSR Blank0106TextBuffer
#_009EB9: LDA.w #$000C
#_009EBC: STA.w $0E00
...
#_009EE5: PHP
#_009EE6: REP #$30
#_009EE8: JSR Blank0106TextBuffer
#_009EEB: LDA.w #VRAMaddr($7C46)
#_009EEE: STA.w $0102
#_009EF1: LDA.w #$0006
#_009EF4: STA.w $0104
#_009EF7: LDA.w #$8042
...
#_00A23E: LDX.w #$0040
#_00A241: LDY.w #$0000
#_00A244: JSL ReadDemonName_long
...
#_00A3FA: LDX.w #$0024
#_00A3FD: LDY.w #$0000
#_00A400: JSL ReadDemonName_long
...
#_00A46A: LDX.w #$002C
#_00A46D: LDY.w #$0000
#_00A470: JSL ReadDemonName_long
...
#_00A50A: LDX.w #$0032
#_00A50D: LDY.w #$0000
#_00A510: JSL ReadDemonName_long
...
#_00A5F7: LDX.w #$0022
#_00A5FA: LDY.w #$0000
#_00A5FD: JSL ReadDemonName_long
...
#_00AAE2: PHY
#_00AAE3: CMP.b #$CF
#_00AAE5: BEQ .branch00A3EB

#_00AAE7: CMP.b #$9C
#_00AAE9: BCS .branch00AB04
...
#_00AB02: BRA .branch00AB33

.branch00AB04
#_00AB04: CMP.b #$CE
#_00AB06: BNE .branch00AB0E

#_00AB08: LDA.b #$5F
#_00AB0A: LDY.b #$9E
#_00AB0C: BRA .branch00AB1D
...
#_00AD90: PHP
#_00AD91: REP #$30
#_00AD93: JSR Blank0106TextBuffer
#_00AD96: LDA.w #$803C
#_00AD99: STA.w $0100
...
#_00C8CC: JSR routine00C9C9
#_00C8CF: BRA .branch00C902

.branch00C8D1
#_00C8D1: JSR routine00CA49
...
#_00C8FF: JSR routine00CC7B

.branch00C902
#_00C902: JSL routine00D3B7
...
#_00CAD3: PHP
#_00CAD4: SEP #$30
#_00CAD6: JSR routine00C9C9
#_00CAD9: JSL routine00D3B7
#_00CADD: LDA.w $040D
#_00CAE0: INC A
#_00CAE1: AND.b #$03
#_00CAE3: STA.w $040D
...
#_00CAE8: LDY.b #$A0
#_00CAEA: LDA.b #$2A
#_00CAEC: JSR SomeDungeonCheck
#_00CAEF: JSR routine00C9C9
#_00CAF2: PLP
#_00CAF3: RTL
...
routine00CBBF:
#_00CBBF: REP #$30
#_00CBC1: LDA.w #data07A40D
#_00CBC4: LDX.w #$0004
#_00CBC7: JSR routine00D1A6
...
#_00CCC4: INY
#_00CCC5: CPY.w #$000C
#_00CCC8: BCC .branch00CC84

.branch00CCCA
#_00CCCA: JSL routine00CCE5
#_00CCCE: BCC .branch00CCDF
...
#_00CCF9: BMI .clc_exit

#_00CCFB: CPX.w #$0180
#_00CCFE: BCC .branch00CD09

#_00CD00: STX.w $0715
#_00CD03: LDA.w #$0001
#_00CD06: JSR SomethingWithHP
...
#_00CD1F: BMI .branch00CD3A

#_00CD21: CPX.w #$0180
#_00CD24: BCC .branch00CD30
...
#_00CD70: SBC.w #$0000
#_00CD73: STA.w $040B
#_00CD76: BCC .branch00CD7D

#_00CD78: ORA.w $0409
#_00CD7B: BNE .EXIT_CLC_00CD89
...
routine00CDCB:
#_00CDCB: PHP
#_00CDCC: JSR routine00D598
#_00CDCF: LDA.w $0711
#_00CDD2: AND.b #$0F
#_00CDD4: BEQ EXIT_CLC_00CE55

#_00CDD6: CMP.b #$0C
#_00CDD8: BCS EXIT_CLC_00CE55

#_00CDDA: CMP.b #$0A
#_00CDDC: BCS .branch00CDE3

#_00CDDE: BIT.w $0719
#_00CDE1: BPL EXIT_CLC_00CE55

.branch00CDE3
#_00CDE3: DEC A
#_00CDE4: ASL A
#_00CDE5: TAX
#_00CDE6: LDA.l data00CE58+0,X
#_00CDEA: STA.w $00E0
#_00CDED: LDA.l data00CE58+1,X
#_00CDF1: STA.w $00E1
#_00CDF4: LDA.w $0719
#_00CDF7: AND.b #$7F
#_00CDF9: STA.w $0719
...
.branch00CE4A
#_00CE4A: JSR routine00C9C9

.branch00CE4D
#_00CE4D: JSL UpdateDirTilemap
#_00CE51: JSL routine00D3B7
...
data00CE58:
#_00CE58: dw routine00CE07
#_00CE5A: dw routine00CE6E
#_00CE5C: dw routine00CE6E
#_00CE5E: dw routine00CE6E
#_00CE60: dw routine00CF4C
#_00CE62: dw routine00CFA2
#_00CE64: dw routine00CFF8
#_00CE66: dw routine00D082
#_00CE68: dw routine00D082
#_00CE6A: dw routine00D126
...
#_00CED1: PHA
#_00CED2: PHX
#_00CED3: LDA.w #!SFX_0F
#_00CED6: JSL Write_to_APU_transferrable
#_00CEDA: PLX
#_00CEDB: PLA
#_00CEDC: JSR SomethingWithHP
...
routine00CF4C:
#_00CF4C: REP #$30
#_00CF4E: LDA.w #data079EFD
#_00CF51: LDX.w #$0006
#_00CF54: JSR routine00D1A6
...
routine00CFF8:
#_00CFF8: REP #$30
#_00CFFA: LDA.w #data07A264
#_00CFFD: LDX.w #$0008
#_00D000: JSR routine00D1A6
...
routine00D082:
#_00D082: REP #$30
#_00D084: LDA.w #data079478
#_00D087: LDX.w #$0006
#_00D08A: JSR routine00D1A6
...
routine00D126:
#_00D126: REP #$30
#_00D128: LDA.w #data079AD6
#_00D12B: LDX.w #$0003
#_00D12E: JSR routine00D1DE
...
#_00D142: PHP
#_00D143: REP #$30
#_00D145: LDA.w #data079AD6
#_00D148: LDX.w #$0003
#_00D14B: JSR routine00D1DE
...
routine00D15E:
#_00D15E: REP #$30
#_00D160: LDA.w #data0798E1
#_00D163: LDX.w #$0004
#_00D166: JSR routine00D1DE
#_00D169: BCS .EXIT_CLC_00D1A3

#_00D16B: STX.w $0A12
#_00D16E: JSL routine00D3DA
#_00D172: LDA.w #$0003
#_00D175: JSL routine00B99C
...
#_00D5A0: REP #$30
#_00D5A2: LDA.w #data07AAC0
#_00D5A5: LDX.w #$0004
#_00D5A8: JSR routine00D1DE
...
data00DAE9:
#_00DAE9: db $02,$01,$05,$01,$06,$01,$07,$01
#_00DAF1: db $09,$02,$03,$00,$0A,$03,$08,$03
#_00DAF9: db $01,$00,$00,$02,$04,$05,$0B,$05
#_00DB01: db $0C,$00,$0D,$01,$0E,$05,$10,$00
#_00DB09: db $0F,$03,$12,$05,$11,$04,$13,$04
#_00DB11: db $14,$00,$15,$00,$16,$03,$17,$02
#_00DB19: db $03,$02,$04,$01,$02,$00,$00

MusicTracksTable:
#_00DB20: db !SONG_4C_EMBASSY
#_00DB21: db !SONG_4A_SHIBUYA
#_00DB22: db !SONG_4B_SHITENOU
#_00DB23: db !SONG_4C_EMBASSY
#_00DB24: db !SONG_4C_EMBASSY
#_00DB25: db !SONG_52_DREAM
#_00DB26: db !SONG_4A_SHIBUYA
#_00DB27: db !SONG_4D_ARCADE
#_00DB28: db !SONG_4D_ARCADE
#_00DB29: db !SONG_4A_SHIBUYA
#_00DB2A: db !SONG_52_DREAM
#_00DB2B: db !SONG_48_GINZA
#_00DB2C: db !SONG_48_GINZA
#_00DB2D: db !SONG_4A_SHIBUYA
#_00DB2E: db !SONG_4C_EMBASSY
#_00DB2F: db !SONG_48_GINZA
#_00DB30: db !SONG_4A_SHIBUYA
#_00DB31: db !SONG_4D_ARCADE
#_00DB32: db !SONG_4B_SHITENOU
#_00DB33: db !SONG_49_CATHEDRAL
#_00DB34: db !SONG_49_CATHEDRAL
#_00DB35: db !SONG_4A_SHIBUYA
#_00DB36: db !SONG_4A_SHIBUYA
#_00DB37: db !SONG_4D_ARCADE
#_00DB38: db !SONG_4B_SHITENOU
#_00DB39: db !SONG_4B_SHITENOU
#_00DB3A: db !SONG_53_HOME
#_00DB3B: db !SONG_4D_ARCADE
...
#_00EF6A: REP #$30
#_00EF6C: CLC
#_00EF6D: LDA.l data00EF83,X
#_00EF71: ADC.w $0CF5
#_00EF74: STA.w $0CF5
#_00EF77: CLC
#_00EF78: LDA.l data00EF8B,X
#_00EF7C: ADC.w $0CF7
#_00EF7F: STA.w $0CF7
#_00EF82: RTS
...
#_00EFB1: SEP #$30
#_00EFB3: LDA.w $040D
#_00EFB6: BEQ .branch00EFC9

#_00EFB8: CMP.b #$01
#_00EFBA: BNE .branch00EFBF

#_00EFBC: JMP .branch00F03D

.branch00EFBF
#_00EFBF: CMP.b #$02
#_00EFC1: BNE .branch00EFC6

#_00EFC3: JMP .branch00F0B1

.branch00EFC6
#_00EFC6: JMP .branch00F125
...
routine00F1B7:
#_00F1B7: PHY
#_00F1B8: JSR routine00F220
#_00F1BB: LDA.w $0CF9
#_00F1BE: BNE .EXIT_00F1F8

#_00F1C0: JSR routine00F1FA
#_00F1C3: LDA.w $0CF9
#_00F1C6: BEQ .EXIT_00F1F8
...
#_00F24E: REP #$30
#_00F250: AND.w #$0003
#_00F253: BEQ branch00F2CF

#_00F255: CMP.w #$0001
#_00F258: BEQ .branch00F281

#_00F25A: CMP.w #$0002
#_00F25D: BEQ .branch00F2A3

#_00F25F: LDA.w $0CF9
#_00F262: PHA
#_00F263: AND.w #$0003
#_00F266: LDY.w #$0006
#_00F269: JSR routine00ED5C
#_00F26C: STA.w $0CF9
#_00F26F: PLA
#_00F270: AND.w #$00FC
#_00F273: LDY.w #$0002
#_00F276: JSR routine00ED63
#_00F279: ORA.w $0CF9
#_00F27C: STA.w $0CF9
#_00F27F: BRA branch00F2CF
...
#_00F285: AND.w #$00C0
#_00F288: LDY.w #$0006
#_00F28B: JSR routine00ED63
#_00F28E: STA.w $0CF9
#_00F291: PLA
#_00F292: AND.w #$003F
#_00F295: LDY.w #$0002
#_00F298: JSR routine00ED5C
#_00F29B: ORA.w $0CF9
#_00F29E: STA.w $0CF9
#_00F2A1: BRA branch00F2CF
...
#_00F2A7: AND.w #$00F0
#_00F2AA: LDY.w #$0004
#_00F2AD: JSR routine00ED63
#_00F2B0: STA.w $0CF9
#_00F2B3: PLA
#_00F2B4: AND.w #$000F
#_00F2B7: LDY.w #$0004
#_00F2BA: JSR routine00ED5C
#_00F2BD: ORA.w $0CF9
#_00F2C0: STA.w $0CF9
#_00F2C3: BRA branch00F2CF
